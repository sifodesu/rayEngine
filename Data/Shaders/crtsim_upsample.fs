...
uniform float bloomUpsampleSpread;
...
void main() {
    ...
    vec2 bloomScale = aspect * bloomUpsampleSpread;
    vec2 p0 = vec2(0.000000, 0.000000).yx;
    vec2 p1 = vec2(0.000000, 1.000000).yx;
    vec2 p2 = vec2(0.000000, -1.000000).yx;
    vec2 p3 = vec2(-0.866025, 0.500000).yx;
    vec2 p4 = vec2(-0.866025, -0.500000).yx;
    vec2 p5 = vec2(0.866025, 0.500000).yx;
    vec2 p6 = vec2(0.866025, -0.500000).yx;
